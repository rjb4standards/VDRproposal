# 2018-2025 Copyright and all other rights reserved by Business Cyber Guardian (businesscyberguardian.com)
# Licensed under GNU GENERAL PUBLIC LICENSE Version 3, 29 June 2007, see LICENSE file for details
...
#    print("ROOTNS:",rootns, ns)
    ...
    with open(fnjson, "w") as JSONData:
        ...
        print("ERROR during VDR conversion:", sys.exc_info())